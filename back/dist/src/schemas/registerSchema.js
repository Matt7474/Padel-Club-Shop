...
const addressSchema = joi_1.default.object({
    street_number: joi_1.default.string()
        .min(1)
        .max(10)
        ...
        .required()
        .messages({
        "string.pattern.base": "Le numéro de rue ne doit contenir que des lettres, chiffres, espaces, '/', '-' ou apostrophes.",
    ...
    street_name: joi_1.default.string()
        .min(2)
        .max(100)
    ...
    additional_info: joi_1.default.string()
        ...
        .allow("", null)
        .messages({
        "string.max": "Le complément d'adresse ne doit pas dépasser 200 caractères.",
        "string.pattern.base": "Le complément d'adresse ne peut pas contenir de balises HTML ou de caractères spéciaux (<, >).",
    }),
    zipcode: joi_1.default.string()
        ...
        .required()
        .messages({
        "string.pattern.base": "Le code postal contient des caractères invalides.",
    ...
    city: joi_1.default.string()
        ...
        .required()
        .messages({
        "string.pattern.base": "La ville ne doit contenir que des lettres, tirets ou apostrophes.",
    ...
    country: joi_1.default.string()
        ...
        .required()
        .messages({
        "string.pattern.base": "Le pays ne doit contenir que des lettres, tirets ou apostrophes.",
...
exports.registerSchema = joi_1.default.object({
    first_name: joi_1.default.string()
        ...
        .required()
        .messages({
        "string.pattern.base": "Le prénom ne doit contenir que des lettres, tirets ou apostrophes.",
    ...
    last_name: joi_1.default.string()
        ...
        .required()
        .messages({
        "string.pattern.base": "Le nom ne doit contenir que des lettres, tirets ou apostrophes.",
    ...
    phone: joi_1.default.string()
        ...
        .allow("", null)
        .messages({
        "string.pattern.base": "Le téléphone ne doit contenir que chiffres, espaces, +, (), . ou -.",
    }),
